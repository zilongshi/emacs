...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (window-number web-mode use-package undo-tree sws-mode solarized-theme smex slime shell-command react-snippets powerline popup markdown-mode lua-mode js2-mode jade-mode elpy company-irony bash-completion))))
(custom-set-faces
